            ...
            <Fade cascade>
                <div className="text-left flex flex-col lg:gap-y-8 gap-y-6">
                    ...
                    <div className="lg:space-x-8 space-x-5 flex lg:justify-start text-nowrap justify-center">
                        <a download={"Mohamed_Khassar_CV(ENG).pdf"} href="/public/assets/files/Mohamed_Khassar_CV(ENG).pdf" className="outline-none shadow-2xl shadow-black/80 py-3 px-5 lg:text-xl bg-black text-white capitalize font-semibold rounded-md flex gap-x-3 text-xs items-center">my resume <ArrowDown className="animate-bounce lg:size-max size-5" /> </a>
                        <button className="text-xs outline-none shadow-2xl shadow-slate-500/80 py-3 px-5 lg:text-xl text-black bg-[#ebebeb] hover:bg-[#d8d8d8] duration-300 capitalize font-semibold rounded-md">browse my projects</button>
                    </div>
                </div>
