...
const ReviewsCard = ({ content,
    ...
    return (
        <div
            ...
            className={`bg-zinc-800 p-5 rounded-xl min-w-[220px] lg:w-[520px] w-[320px] flex flex-col lg:min-w-[320px] h-full ${isArabic ? "text-right" : "text-left"}`}>
            ...
            <div className="flex items-center gap-2 mt-auto">
                ...
                <div>
                    ...
                    <p className="text-sm text-zinc-400 tracking-wider font-bold">
                        {company}
                    </p>
                </div>
            </div>
